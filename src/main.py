...
class Pearl:
    ...
    def __init__(self):
        ...
        self.cur_state = ['1' if i < args.num_trees else '0' for i in range(0, repo_size)]
    
        self.lru_states = LRU_state(capacity=repo_size, edit_distance_threshold=args.edit_distance_threshold)
        self.lru_states.enqueue(self.cur_state)
    
        self.state_graph = LossyStateGraph(repo_size, args.lossy_window_size)
    
        self.graph_switch = GraphSwitch(window_size=args.reuse_window_size,
